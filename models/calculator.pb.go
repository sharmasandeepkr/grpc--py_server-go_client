...
func (*Number) Descriptor() ([]byte, []int) {
	return fileDescriptor_calculator_2b31b735ee02dbfe, []int{0}
}
...
func (m *Number) GetValue() float32 {
	if m != nil {
		return m.Value
	}
	return 0
...
func init() {
	proto.RegisterType((*Number)(nil), "models.Number")
}
...
func (c *calculatorClient) SquareRoot(ctx context.Context, in *Number, opts ...grpc.CallOption) (*Number, error) {
	out := new(Number)
	err := c.cc.Invoke(ctx, "/models.Calculator/SquareRoot", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Calculator_SquareRoot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/models.Calculator/SquareRoot",
	}
...
var _Calculator_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "models/calculator.proto",
}

func init() { proto.RegisterFile("models/calculator.proto", fileDescriptor_calculator_2b31b735ee02dbfe) }

var fileDescriptor_calculator_2b31b735ee02dbfe = []byte{
	// 120 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0xcf, 0xcd, 0x4f, 0x49,
	0xcd, 0x29, 0xd6, 0x4f, 0x4e, 0xcc, 0x49, 0x2e, 0xcd, 0x49, 0x2c, 0xc9, 0x2f, 0xd2, 0x2b, 0x28,
	0xca, 0x2f, 0xc9, 0x17, 0x62, 0x83, 0x48, 0x28, 0xc9, 0x71, 0xb1, 0xf9, 0x95, 0xe6, 0x26, 0xa5,
	0x16, 0x09, 0x89, 0x70, 0xb1, 0x96, 0x25, 0xe6, 0x94, 0xa6, 0x4a, 0x30, 0x2a, 0x30, 0x6a, 0x30,
	0x05, 0x41, 0x38, 0x46, 0x36, 0x5c, 0x5c, 0xce, 0x70, 0xbd, 0x42, 0x7a, 0x5c, 0x5c, 0xc1, 0x85,
	0xa5, 0x89, 0x45, 0xa9, 0x41, 0xf9, 0xf9, 0x25, 0x42, 0x7c, 0x7a, 0x10, 0x43, 0xf4, 0x20, 0x26,
	0x48, 0xa1, 0xf1, 0x95, 0x18, 0x92, 0xd8, 0xc0, 0x96, 0x19, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff,
	0x29, 0xc9, 0xa2, 0x07, 0x87, 0x00, 0x00, 0x00,
}
